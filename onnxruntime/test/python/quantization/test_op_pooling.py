...
class TestOpAveragePool(unittest.TestCase):
    ...
    def quantize_avgpool_test(self, model_fp32_path, data_reader, activation_type=QuantType.QUInt8):
        ...
        model_q8_qdq_path = 'avgpool_{}_qdq.onnx'.format(activation_type_str)
    ...
    def test_quantize_avgpool(self):
        ...
        self.quantize_avgpool_test(model_fp32_path, data_reader, QuantType.QUInt8)
        self.quantize_avgpool_test(model_fp32_path, data_reader, QuantType.QInt8)
